 ...
 * -t /home/nayyar/workspace/j_work/weka3-7-5/datasets_O/chess.arff -D -O "MSE" -R "None"
 <!-- options-end -->
 *
 * @author 
 * @version $2.0$
 */
public class CAVWNB_MSE extends AbstractClassifier 
...
TechnicalInformationHandler {
	...
	private String objectiveFunction = "MSE";	
	...
	public void buildClassifier(Instances instances) throws Exception {
		...
		WANBObjectiveFunction obj = new RegularizedObjectiveFunctionFactory().getObjectiveFunction(objectiveFunction, regularizer, attrValueCounts * m_NumClasses);
		...
		if (!instance.classIsMissing()) {
			...
			while (enumAtts.hasMoreElements()) {
				...
				if (!instance.isMissing(attribute)) 
					m_Distributions[att][(int)instance.classValue()].addValue(instance.value(attribute), instance.weight());					
				else
					m_Distributions[att][(int)instance.classValue()].addValue(attribute.numValues(), instance.weight());
				}
				att++;
			}
   ...
   <!-- options-end -->
	...
	public static void main(String [] argv) {
		runClassifier(new CAVWNB_MSE(), argv);
	}
