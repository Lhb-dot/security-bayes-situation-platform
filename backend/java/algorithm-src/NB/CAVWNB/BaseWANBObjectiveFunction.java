...
//		int m = instances2.numAttributes();
		...
		log_gamma_UNC = new double[m][nc][N];
		for (int u = 0; u < m; u++) {
	...
	// 1. 在类的最上方增加一个全局静态变量，用来记录当前是第几个 Fold
    public static int globalFoldCounter = 0;
    
    // 2. 增加当前实例的局部变量
    private int currentFoldID = 0;
    private int evalCount = 0; 
    private double[] lastWeights = null;
