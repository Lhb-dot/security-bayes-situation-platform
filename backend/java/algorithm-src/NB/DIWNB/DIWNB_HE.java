...
public class DIWNB_HE extends AbstractClassifier implements OptionHandler{

	/**
	 * Eager Dual-View Instance Weighted NB with Hard Label
	...
	public  AbstractClassifier classifier_view1 = new weka.classifiers.mkx.DIWNB.AVFWNB();

	public  AbstractClassifier classifier_view2 = new weka.classifiers.mkx.DIWNB.AVFWNB();
	...
	public final static int BEST_NUM = 5;
	...
	/** 原始视图（Original Attribute Space）的类别概率分布（供可解释性展示）。 */
	public double[] distributionForView1(Instance instance) throws Exception {
		return classifier_view1.distributionForInstance(instance);
	}

	/** 生成视图（Generated Attribute Space）的类别概率分布（供可解释性展示）。 */
	public double[] distributionForView2(Instance instance) throws Exception {
		...
		return classifier_view2.distributionForInstance(predData_view2.instance(0));
	}

	/** 视图融合权重（与 distributionForInstance 一致：view1 用 view_weight[1]，view2 用 view_weight[0]）。 */
	public double[] getViewWeightsForReport() {
