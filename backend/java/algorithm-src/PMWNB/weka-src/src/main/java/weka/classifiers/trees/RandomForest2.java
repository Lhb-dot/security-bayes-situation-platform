 ...
 */
// .
public class RandomForest2 extends AbstractClassifier implements OptionHandler,
  ...
  public String getTreesDetails() {
	    ...
	    // 开启 Bagging 内部打印基分类器的开关
	    m_bagger.setPrintClassifiers(true);
	    return m_bagger.toString();
	  }
  ...
  public void distributionForInstance_c_p(Instance instance, String[] pred_label, double[][] probs) throws Exception {
    m_bagger.distributionForInstance_c_p(instance, pred_label, probs);
  }

  public void distributionForInstance_c_p_rank(Instance instance, String[] pred_label, double[][] probs,
      double[][] probs_rank) throws Exception {
    m_bagger.distributionForInstance_c_p_rank(instance, pred_label, probs, probs_rank);
  }

  public void distributionForInstance_c_rank(Instance instance, String[] pred_label, double[][] probs)
      throws Exception {
    m_bagger.distributionForInstance_c_rank(instance, pred_label, probs);
  }

  public void distributionForInstance_c_icp(Instance instance, String[] pred_label, double[][] pred_probs)
      throws Exception {
    m_bagger.distributionForInstance_c_icp(instance, pred_label, pred_probs);
  }

  public void distributionForInstance_c_p_x(Instance instance, String[] pred_label, double[][] probs, int numGroups)
      throws Exception {
    m_bagger.distributionForInstance_c_p_x(instance, pred_label, probs, numGroups);
  }

  public void distributionForInstance_pgroups(Instance instance, double[][] pred_probs, int numGroups,
      int[] clusterID) throws Exception {
    m_bagger.distributionForInstance_pgroups(instance, pred_probs, numGroups, clusterID);
  }

  public void diversity(Instance instance, double[][] differences) throws Exception {
    m_bagger.diversity(instance, differences);
  }

  public void diversity_JSD(Instance instance, double[][] differences) throws Exception {
    m_bagger.diversity_JSD(instance, differences);
  }

  public void distributionForInstance_c_p_diversity(Instance instance, String[] pred_label, double[] probs,
      double[][][] differences) throws Exception {
    m_bagger.distributionForInstance_c_p_diversity(instance, pred_label, probs, differences);
  }

  public String[] distributionForInstance1(Instance instance) throws Exception {

    return m_bagger.distributionForInstance1(instance);
  }

  /**
   * m*RF 各自的结果
   * numTrees+bagger ===> RF_m
   */
  public double[] distributionForInstance2(Instance instance) throws Exception {
    return m_bagger.distributionForInstance2(instance);
  }

  /**
   * m*RF 各自的结果
   * numTrees+bagger ===> RF_m sort_idx
   */
  public int[] distributionForInstance_idx(Instance instance, int numBins) throws Exception {
    return m_bagger.distributionForInstance_idx(instance, numBins);
  }

  public String[] distributionForInstance_cand(Instance instance) throws Exception {
    return m_bagger.distributionForInstance_cand(instance);
  }
