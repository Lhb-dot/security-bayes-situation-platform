...
# TRAINING → FAILED / DRAFT；DRAFT → PUBLISHED；PUBLISHED → OFFLINE；OFFLINE → PUBLISHED(重新发布，§6.7.5.7)
MODEL_STATUS_TRANSITIONS = {
    ...
    MODEL_STATUS_PUBLISHED: (MODEL_STATUS_OFFLINE,),
    MODEL_STATUS_OFFLINE: (MODEL_STATUS_PUBLISHED,),  # 管理员可重新发布已下线模型
}
