...
api_router.include_router(ai_setting_routes.router)
api_router.include_router(explanation_routes.router)
...
api_router.include_router(model_evaluation_routes.router)
